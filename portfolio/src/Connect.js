		...
		<div className="connect container"> 
			...
			<p className="work-intro">As they say in Oakland, Holla at me and we can have some tea & crumpets.</p>
			 <a href="mailto:moe.himed@gmail.com" className=" glyph" target="_blank" rel="noopener noreferrer">A</a> 
 			 ...
 			 <a href="https://www.linkedin.com/in/moe-himed-" className=" glyph" target="_blank" rel="noopener noreferrer">D</a>
 	    	 <a href="https://github.com/MarvelMoe" className="glyph" target="_blank" rel="noopener noreferrer">E</a>
		</div>
